...
def parse_args():
    ...
    optional.add_argument("--x-threads", type=int, default=1, help='The maximum number of threads in the x dimension')
    optional.add_argument("--y-threads", type=int, default=1, help='The maximum number of threads in the y dimension')
    optional.add_argument("--z-threads", type=int, default=1, help='The maximum number of threads in the z dimension')
    optional.add_argument("--x-workgroups", type=int, default=1, help='The maximum number of workgroups in the x dimension')
    optional.add_argument("--y-workgroups", type=int, default=1, help='The maximum number of workgroups in the y dimension')
    optional.add_argument("--z-workgroups", type=int, default=1, help='The maximum number of workgroups in the z dimension')
