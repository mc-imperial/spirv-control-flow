...
This tool encodes a run of a CFG either by choosing a random path (optionally of a given length) or provided by the user. The path must end in a terminal block.
If a path of certain length is asked for, it may minimally extended to make it terminating.
...
```
This tool fleshes out CFG skeletons generated by the Alloy model.

positional arguments:
  xml            The CFG skeleton generated by the Alloy model

optional arguments:
  -h, --help     show this help message and exit
  --l L          This is the minimum lenth of the randomly chosen path: the path may be extended minimally to make it
                 terminating
  --p P [P ...]  A user-input path
```
...
```
python3.9 fleshout.py test_0.xml --l 24
```
generates..
...
; Follow the path:
; 8 -> 9 -> <12> -> <13> -> edge_5 -> <16> -> 23 -> <22> -> 25 -> 24 -> 14 -> 11 -> 9 -> <12> -> <13> -> edge_1 -> <16> -> 23 -> <22> -> 24 -> 14 -> 11 -> 9 -> <12> -> <10> -> 18 -> 17
;
...
; Schema: 0
          ...
          %6 = OpConstant %4 0
               ...
               %directions_16_variable = OpVariable %size_2_pointer_type Uniform
               %directions_13_variable = OpVariable %size_2_pointer_type Uniform
               %directions_22_variable = OpVariable %size_2_pointer_type Uniform
               ...
               %directions_12_variable = OpVariable %size_3_pointer_type Uniform

               %output_array_type = OpTypeArray %4 %constant_25
 ...
 BUFFER directions_12 DATA_TYPE uint32 STD430 DATA 1 1 0 END
 BUFFER directions_13 DATA_TYPE uint32 STD430 DATA 5 1 END
 BUFFER directions_16 DATA_TYPE uint32 STD430 DATA 1 1 END
 BUFFER directions_22 DATA_TYPE uint32 STD430 DATA 1 0 END
 BUFFER directions_10 DATA_TYPE uint32 STD430 DATA 1 END

 BUFFER output DATA_TYPE uint32 STD430 SIZE 25 FILL 0
 ...
 EXPECT directions_12 IDX 0 EQ 1 1 0
 EXPECT directions_13 IDX 0 EQ 5 1
 EXPECT directions_16 IDX 0 EQ 1 1
 EXPECT directions_22 IDX 0 EQ 1 0
 EXPECT directions_10 IDX 0 EQ 1
 EXPECT output IDX 0 EQ 8 9 12 13 16 23 22 25 24 14 11 9 12 13 16 23 22 24 14 11 9 12 10 18 17
